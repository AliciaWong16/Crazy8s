...
public class GameManager {
	...
	private Deck deck;
	private int turn; //will be 0,1,2,or 3
	...
	public boolean play (int index, Player p) //takes in card index (from hand - "-1" will be withdraw for now)
	{
...
/*		if (index > p.getHand().size() || !isPlayLegal(p.getHand().get(index)))
		{
			System.out.println("You can't play that card!");
			return false;
		}*/
		if(index==-1) //if player wants to withdraw
		{
