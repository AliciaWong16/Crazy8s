...
public class Crazy8_main extends Application
{

	public void start(Stage primary) 
	{		
		GridPane mainPane=new GridPane(); //main grid pane
		Scene scene = new Scene (mainPane, 500, 300); //main scene
		
		FlowPane bottomDiv = new FlowPane();
		GridPane topDiv = new GridPane();
		Scene scene2 = new Scene(bottomDiv, 200, 200);
		
		Label testingTop = new Label("testing top");
		topDiv.add(testingTop, 1, 0);
		
		mainPane.add(topDiv, 0, 0);
		Label testing = new Label("Testing the GUI");
		
		primary.setTitle("Crazy 8's, Bitch");
