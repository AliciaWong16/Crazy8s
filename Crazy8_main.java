		...
		{		
				...
				if(index != -2){
					...
					else //if player withdrawing	
					{
						...
						if (crazy.isPlayLegal(crazy.getPlayer().getHand().get((crazy.getPlayer().getHand().size()-1))))
						{
							...
							if(!playW.equalsIgnoreCase("N") && !playW.equalsIgnoreCase("Y")){
							...
							else if (playW.equalsIgnoreCase("Y"))
							{
			...
			//	crazy.play(chosen,false,crazy.getCompPlayer(0));
				if (chosen==-1) //if player withdrawing	
				{
					...
					System.out.println("CP2 withdrew a " + crazy.getCompPlayer(1).getHand().get(crazy.getCompPlayer(1).getHand().size()-1));
				...
				System.out.println("\nCP2 has " + crazy.getCompPlayer(1).getHand().size() + " cards left.");
				System.out.println("Top of discard pile: " + crazy.getDeck().getTopDiscard()); 	
				//checks if player won
			...
			//	crazy.play(chosen,false,crazy.getCompPlayer(0));
				...
				System.out.println("\nCP3 has " + crazy.getCompPlayer(2).getHand().size() + " cards left.");
				System.out.println("Top of discard pile: " + crazy.getDeck().getTopDiscard()); 	
				//checks if player won
